...
func (h *Handler) Execute(input string) bool {
	...
	case "help":
		...
		fmt.Println("  For natural language queries, use the 'ai' command:")
		fmt.Println("  rocksdb-cli ai --db <path> 'your natural language query'")
		fmt.Println("  Examples:")
		fmt.Println("    rocksdb-cli ai --db mydb 'Show me all users'")
		fmt.Println("    rocksdb-cli ai --db mydb 'Find products with category electronics'")
		fmt.Println("")
